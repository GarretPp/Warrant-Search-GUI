...
In the main screen, type in a name (Non-Case-Sensitive) and click search/enter.
  ...
  Double click on warrant to pull up advanced info.
  Active arrests warrants are shown by default unless the bottom left box it ticked.
Click on the ⟳ button to reload the warrant database with the latest info.
  This button also resets the screen.
